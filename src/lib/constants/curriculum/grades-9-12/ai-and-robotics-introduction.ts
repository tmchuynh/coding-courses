...
export const aiAndRoboticsIntroduction: CourseSchedule[] = [
  {
    ...
    outcomes:
      " Students will understand the basic concepts of AI and robotics, and how they interact.",
    project:
      "Research and present on an AI-powered robot, detailing its AI and robotic components.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes:
      " Students will learn to program a microcontroller to control basic robot functions.",
    project:
      "Program a microcontroller on a robot to blink an LED and move a motor.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes:
      " Students will understand how sensors provide data for robot decision-making.",
    project:
      "Use an ultrasonic sensor with the robot to detect an obstacle and stop.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes:
      " Students will learn the basics of machine learning and its applications in robotics.",
    project:
      "Collect a small dataset of sensor readings (e.g., light levels) for two different conditions.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes:
      " Students will learn how to use a camera for basic computer vision tasks.",
    project:
      "Use a simple computer vision script (e.g., with OpenCV on Raspberry Pi) to detect a specific color with a camera.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes:
      " Students will learn how to train a simple machine learning model using a visual tool.",
    project:
      "Train an image classification model using Teachable Machine to distinguish between two hand gestures.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes:
      " Students will learn how to integrate a trained ML model with their robot.",
    project:
      "Integrate the Teachable Machine model with the robot to perform an action based on a recognized hand gesture.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes:
      " Students will understand basic path planning and navigation techniques for robots.",
    project:
      "Program the robot to follow a simple pre-defined path or navigate around a single obstacle.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes:
      " Students will understand the basic concepts of reinforcement learning and how it can be applied to robotics.",
    project:
      "Design a simple reinforcement learning scenario for a robot (e.g., learning to reach a target through trial and error - conceptual).",
    projectDescription:
  ...
  },
  {
    ...
    outcomes:
      " Students will learn how to implement basic voice control for their robot.",
    project:
      "Implement voice control for the robot to perform basic actions like 'move forward' or 'stop'.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes:
      " Students will reflect on the ethical implications of AI and robotics in society.",
    project:
      "Write a short essay on the ethical implications of autonomous delivery robots.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes:
      " Students will apply the AI and robotics concepts learned throughout the course to create a functional robotic project.",
    project:
      "Build a robot that uses a camera to follow a line or a colored object.",
    projectDescription:
