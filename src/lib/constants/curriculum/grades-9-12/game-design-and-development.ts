...
export const gameDesignAndDevelopment: CourseSchedule[] = [
  {
    ...
    outcomes: "",
    project:
      "Analyze a favorite game and document its core elements (rules, goals, feedback, challenge).",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Design and paper prototype a simple game mechanic (e.g., a card game interaction).",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Sketch a map for a game level, indicating key areas and player path.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Write a short character bio and a one-page story outline for a game concept.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project: "Design a wireframe for a game's main menu and HUD.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Set up a new project in the chosen game engine and import a few basic assets.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Implement the core gameplay loop (e.g., player movement and a simple objective) in the game engine.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Add a new mechanic (e.g., collectibles, enemies) to the game prototype.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Conduct a playtest session for the prototype with peers and gather feedback.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Create a mood board for the game's art style and list desired sound effects.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Add simple visual polish (e.g., particle effects) and sound effects to the prototype.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project: "Present the game prototype and a 1-2 page Game Design Document.",
    projectDescription:
