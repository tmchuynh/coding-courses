...
export const nextjsEssentials: CourseSchedule[] = [
  {
    ...
    outcomes: "",
    project:
      "Set up a Next.js project and create a simple home page and an about page with basic routing.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Build a reusable Card component and use it to display a list of items. Implement a simple counter using useState.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Create a dynamic route for blog posts (e.g., /posts/[id]) and a shared layout component.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Fetch and display a list of items from a public API using `getStaticProps` or `getServerSideProps`.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Create an API route that returns a JSON response (e.g., a list of mock users).",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Style a Next.js page using CSS Modules or Tailwind CSS, ensuring responsiveness.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Implement a basic login form and protect a route using NextAuth.js (conceptual or basic setup).",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Manage a global theme (light/dark mode) using Zustand or Redux in a Next.js app.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Build a contact form with client-side validation using a library like React Hook Form.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project: "Optimize images in a Next.js project and deploy it to Vercel.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Write unit tests for a React component and an API route using Jest.",
    projectDescription:
  ...
  },
  {
    ...
    outcomes: "",
    project:
      "Start a capstone project: a simple blog or portfolio website using Next.js.",
    projectDescription:
